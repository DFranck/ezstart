...
const agents = [
  ...
  },
  {
    ...
    files: ['apps/*/web/vercel.json', 'DEPLOY.md'],
    priority: 'High',
    standards: ['Railway', 'Vercel', 'CI/CD', 'Secrets management'],
    bestPractices: ['Infrastructure as Code', 'Health checks', 'Automated deployments'],
    tools: ['Railway', 'Vercel', 'GitHub Actions'],
    criticalCriteria: ['All APIs on Railway', 'Vercel deployments working', 'SSL configured'],
