...
/**
 * User-overridable strings for `<PurchaseCancelPage>`.
 * All fields are optional — English defaults are used when omitted.
 */
export interface PurchaseCancelPageTexts {
...
const DEFAULT_TEXTS: Required<PurchaseCancelPageTexts> = {
 ...
 *   return <PurchaseCancelPage tryAgainHref="/en/purchase" />
 * }
 * ```
 */
export function PurchaseCancelPage({
  ...
  backHomeHref = '/',
  texts,
}: PurchaseCancelPageProps): React.ReactElement {
