...
/**
 * Shared internal base for Stripe Checkout callback pages
 * (success / cancel for donate / purchase / subscribe).
 *
 * @internal — not exported from the package barrel. Used by:
 *   - DonateSuccessPage / DonateCancelPage
 *   - PurchaseSuccessPage / PurchaseCancelPage
 *   - SubscribeSuccessPage / SubscribeCancelPage
 *
...
import { Button, Div, H1, H3, Icon, LI, Main, P, Span, Spinner, UL } from '@ezstart/ui/components'
