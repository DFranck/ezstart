/**
 * Safe server-only guard for @ezstart/pay-sdk/server.
 *
 ...
 *     undefined or stripped, so the guard throws to prevent secret-key
 ...
 *
 * Files in `packages/pay-sdk/src/server/` import this module via a
...
if (!isNode) {
  throw new Error(
    '@ezstart/pay-sdk/server cannot be imported from a Client Component or browser bundle. ' +
      'Use @ezstart/pay-sdk or @ezstart/pay-sdk/components instead.'
  )
}
export {}
