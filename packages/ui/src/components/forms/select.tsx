...
import { touchHeight } from '../../lib/design-system/tokens'
...
function SelectTrigger({
  ...
  const size = (sizeProp ?? inherited.size ?? 'default') as 'sm' | 'default'
  // Determine responsive size based on size prop
  const sizeClass =
    size === 'sm' ? formInputVariantConfig.size.sm : formInputVariantConfig.size.default
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        sizeClass, // Uses formInputVariantConfig size tokens
        className
      )}
      {...props}
    >
