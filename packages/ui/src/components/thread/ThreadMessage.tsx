...
export const ThreadMessage = React.memo(function ThreadMessage({
  ...
  const [editedContent, setEditedContent] = useState(typeof children === 'string' ? children : '')
          ...
          <div className={clsx('flex w-full', isUser ? 'justify-end' : 'justify-start')}>
            <div
              className={clsx(
                ...
                isEditing
                  ? 'p-2'
                  : 'whitespace-pre-wrap break-words overflow-hidden leading-tight select-text',
                isUser
                        ...
                        components={{
                          ...
                          code: ({ node, inline, ...props }: any) =>
                            inline ? (
                              ...
                              <code
                                className="block bg-muted p-2 rounded text-sm my-2 overflow-x-auto"
                                {...props}
                              />
                            ),
                          strong: ({ node, ...props }) => (
