...
import { touchHeight, paddingX, paddingY, fontSize } from '../lib/design-system/tokens';
...
function SelectTrigger({
  ...
  // Determine responsive height based on size prop
  const heightClass = size === 'sm' ? touchHeight.sm : touchHeight.default;
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        heightClass, // h-11 sm:h-9 (default) or h-10 sm:h-8 (sm)
