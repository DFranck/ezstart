...
export interface ScopeContextSwitcherTexts {
...
export interface ScopeContextSwitcherLinkProps {
  href: string
  children: ReactNode
  className?: string
}

export interface ScopeContextSwitcherProps {
  ...
  LinkComponent?: ComponentType<ScopeContextSwitcherLinkProps>
  /** Optional override of the default English texts. */
  texts?: Partial<ScopeContextSwitcherTexts>
...
const DEFAULT_TEXTS: ScopeContextSwitcherTexts = {
...
/**
 * Visual context switcher for SaaS apps where superadmins toggle between
 ...
 * ```
 */
export function ScopeContextSwitcher({
  scope,
  canSwitchToAdmin,
  switchPath,
  LinkComponent,
  ...
  const ResolvedLink: ComponentType<ScopeContextSwitcherLinkProps> =
    LinkComponent ??
