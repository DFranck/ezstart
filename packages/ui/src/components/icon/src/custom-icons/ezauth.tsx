...
export default function Ezauth(props: IconProps) {
  return (
    <svg
      {...props}
      viewBox='0 0 512 512'
    ...
    >
      <g clipPath='url(#clip0_ezauth)'>
        <path
          d='M256 512C397.385 512 512 397.385 512 256C512 114.615 397.385 0 256 0C114.615 0 0 114.615 0 256C0 397.385 114.615 512 256 512Z'
          fill='url(#paint0_linear_ezauth)'
        />
        <path
        ...
        <path
          ...
          fill={props.fill ? `hsl(var(--${props.fill}))` : '#00D9F7'}
        />
        <path
