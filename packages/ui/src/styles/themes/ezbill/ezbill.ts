...
.dark {
  ...
  --ezbill-invoice: oklch(0.640 0.178 251);
  ...
  --ezbill-sent: oklch(0.640 0.178 251);
...
@layer utilities {
  ...
  .bg-gradient-client-light {
    background: linear-gradient(to right, oklch(0.805 0.161 210 / 0.2), oklch(0.705 0.143 247 / 0.2));
  }
  .bg-gradient-invoice-light {
    background: linear-gradient(to right, oklch(0.705 0.143 247 / 0.2), oklch(0.675 0.151 273 / 0.2));
  }
  ...
  .bg-gradient-payment-light {
    background: linear-gradient(to right, oklch(0.805 0.175 145 / 0.2), oklch(0.782 0.147 166 / 0.2));
  }
  .bg-gradient-company-light {
    background: linear-gradient(to right, oklch(0.675 0.151 273 / 0.2), oklch(0.715 0.206 298 / 0.2));
  }
  .bg-gradient-receipt-light {
    background: linear-gradient(to right, oklch(0.715 0.206 298 / 0.2), oklch(0.703 0.195 340 / 0.2));
  }
}
`
