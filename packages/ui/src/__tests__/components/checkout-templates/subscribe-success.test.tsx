/**
 * SubscribeSuccessTemplate — drop-in subscribe success landing.
 *
 * Verifies:
...
const { SubscribeSuccessTemplate } =
  await import('../../../components/checkout-templates/subscribe-success')

describe('SubscribeSuccessTemplate', () => {
  beforeEach(() => {
    pushMock.mockClear()
  ...
  it('renders English defaults', () => {
    render(<SubscribeSuccessTemplate redirectTo="/dashboard" redirectDelayMs={0} />)
