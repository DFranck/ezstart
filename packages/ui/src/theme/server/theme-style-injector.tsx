...
import { fetchThemeOverrides, generateThemeCSS } from './fetch-theme-overrides.js'
 ...
 * ```tsx
 * // app/layout.tsx
 * import { ThemeStyleInjector } from '@ezstart/ui/theme/server'
 *
 * export default function RootLayout({ children }) {
 *   return (
 *     <html>
 *       <head>
 *         <ThemeStyleInjector appName="myapp" />
 *       </head>
 *       <body>{children}</body>
 *     </html>
 *   )
