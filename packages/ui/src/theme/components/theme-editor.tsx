...
import { ThemeEditor as UIThemeEditor } from '../../components/index.js'
import { useTheme } from 'next-themes'
import { useThemeSelectorContext } from '../theme-selector-context.js'
 ...
 * Example:
 * ```tsx
 * <ThemeProvider themeSelector={{ appName: 'myapp', globalCss, appCss }}>
 *   <ThemeEditor />
 * </ThemeProvider>
 * ```
 */
