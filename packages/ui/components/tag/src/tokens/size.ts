...
export const containerSizeVariants = {
  xs: 'max-w-2xl px-4 py-4 gap-2 justify-center',
  sm: 'max-w-3xl px-4 md:px-6 py-6 md:py-10 gap-2 md:gap-4 justify-center items-center',
  xl: 'max-w-5xl px-4 md:px-10 py-10 md:py-24 gap-4 md:gap-8',
  full: 'max-w-none px-2 md:px-10 py-4 md:py-10 gap-6 md:gap-8',
