...
export interface TurnstileWidgetProps {
   ...
   * widget renders nothing (no-op). This lets consumers ship the SDK
   * without captcha and enable it later by setting `NEXT_PUBLIC_TURNSTILE_SITE_KEY`.
   */
  siteKey?: string
  /**
...
export function TurnstileWidget({
  ...
  }, [siteKey, onSuccess, onError, onExpired, theme, appearance])
