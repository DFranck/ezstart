export declare const Link: import("react").ForwardRefExoticComponent<Omit<{
    ...
    locale?: import("next-intl", { with: { "resolution-mode": "import" } }).Locale | undefined;
    ...
    locale: import("next-intl", { with: { "resolution-mode": "import" } }).Locale;
    forcePrefix?: boolean;
...
export declare function createCustomNavigation(routing: any): {
