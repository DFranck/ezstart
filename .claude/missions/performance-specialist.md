# 🤖 performance Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** Performance
**Audit File:** `docs/audits/performance-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Performance** pour le monorepo @ezstart.
...
- **Apps:** All 8 web apps
- **Fichiers clés:** `apps/*/web/src/app/`, `apps/*/web/next.config.js`, `packages/ui/`
...
**Actions:**
1. Lire `docs/audits/performance-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/performance-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/performance-AUDIT.md`
...
- [docs/audits/performance-AUDIT.md](../../docs/audits/performance-AUDIT.md)
...
```
🔍 Audit performance - Score actuel: XX/100
