# 🤖 testing Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** Testing
**Audit File:** `docs/audits/testing-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Testing** pour le monorepo @ezstart.
...
- **Apps:** All apps
- **Fichiers clés:** `**/*.test.ts`, `**/*.test.tsx`, `vitest.config.ts files`
...
**Actions:**
1. Lire `docs/audits/testing-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/testing-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/testing-AUDIT.md`
...
- [docs/audits/testing-AUDIT.md](../../docs/audits/testing-AUDIT.md)
...
```
🔍 Audit testing - Score actuel: XX/100
