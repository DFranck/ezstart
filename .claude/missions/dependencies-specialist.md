# 🤖 dependencies Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** Dependencies
**Audit File:** `docs/audits/dependencies-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Dependencies** pour le monorepo @ezstart.
...
**Actions:**
1. Lire `docs/audits/dependencies-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/dependencies-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/dependencies-AUDIT.md`
...
- [docs/audits/dependencies-AUDIT.md](../../docs/audits/dependencies-AUDIT.md)
...
```
🔍 Audit dependencies - Score actuel: XX/100
