# 🤖 documentation Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** Documentation
**Audit File:** `docs/audits/documentation-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Documentation** pour le monorepo @ezstart.
...
- **Apps:** All apps
- **Fichiers clés:** `docs/`, `*/README.md`, `*/CHANGELOG.md`, `CLAUDE.md`, `DEV-RULES.md`
...
**Actions:**
1. Lire `docs/audits/documentation-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/documentation-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/documentation-AUDIT.md`
...
- [docs/audits/documentation-AUDIT.md](../../docs/audits/documentation-AUDIT.md)
...
```
🔍 Audit documentation - Score actuel: XX/100
