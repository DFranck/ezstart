# 🤖 ux Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** UX
**Audit File:** `docs/audits/ux-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **UX** pour le monorepo @ezstart.
...
- **Packages:** @ezstart/ui
- **Apps:** All 8 web apps
- **Fichiers clés:** `packages/ui/`, `apps/*/web/src/components/`, `apps/*/web/src/app/`
...
**Actions:**
1. Lire `docs/audits/ux-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/ux-AUDIT.md` avec:
   - Nouveau score
...
- [docs/audits/ux-AUDIT.md](../../docs/audits/ux-AUDIT.md)
