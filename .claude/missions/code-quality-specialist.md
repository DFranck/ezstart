# 🤖 code-quality Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** Code Quality
**Audit File:** `docs/audits/code-quality-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Code Quality** pour le monorepo @ezstart.
...
- **Fichiers clés:** `**/*.ts`, `**/*.tsx`, `eslint.config.js`, `tsconfig.json`
...
**Actions:**
1. Lire `docs/audits/code-quality-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/code-quality-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/code-quality-AUDIT.md`
...
- [docs/audits/code-quality-AUDIT.md](../../docs/audits/code-quality-AUDIT.md)
...
```
🔍 Audit code-quality - Score actuel: XX/100
