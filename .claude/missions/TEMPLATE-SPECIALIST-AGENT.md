...
**Domain:** [DOMAIN_NAME]
**Audit File:** `docs/audits/[DOMAIN]-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **[DOMAIN_NAME]** pour le monorepo @ezstart.
...
**Périmètre:**
- Packages concernés: [LIST]
- Apps concernées: [LIST]
- Fichiers clés: [LIST]
...
**Actions:**
1. Lire `docs/audits/[DOMAIN]-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/[DOMAIN]-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/[DOMAIN]-AUDIT.md`
...
- [docs/audits/[DOMAIN]-AUDIT.md](../../docs/audits/[DOMAIN]-AUDIT.md)
...
```
🔍 Audit [DOMAIN] - Score actuel: XX/100
