# 🤖 mobile-ux Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** Mobile UX
**Audit File:** `docs/audits/mobile-ux-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Mobile UX** pour le monorepo @ezstart.
...
- **Packages:** @ezstart/ui
- **Apps:** All 8 web apps
- **Fichiers clés:** `packages/ui/`, `apps/*/web/tailwind.config.js`
...
**Actions:**
1. Lire `docs/audits/mobile-ux-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/mobile-ux-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/mobile-ux-AUDIT.md`
...
2. `safe-area CSS`
3. `@ezstart/ui mobile components`
...
- [docs/audits/mobile-ux-AUDIT.md](../../docs/audits/mobile-ux-AUDIT.md)
...
```
🔍 Audit mobile-ux - Score actuel: XX/100
