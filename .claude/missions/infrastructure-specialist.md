...
**Audit File:** `docs/audits/infrastructure-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Infrastructure** pour le monorepo @ezstart.
...
- **Fichiers clés:** `docker-compose.yml`, `nginx/`, `scripts/oracle-*.sh`, `.env.oracle`
...
**Actions:**
1. Lire `docs/audits/infrastructure-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/infrastructure-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/infrastructure-AUDIT.md`
...
- [docs/audits/infrastructure-AUDIT.md](../../docs/audits/infrastructure-AUDIT.md)
...
```
🔍 Audit infrastructure - Score actuel: XX/100
