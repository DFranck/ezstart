# 🤖 monitoring Specialist Agent - Template

**Agent Type:** Domain Specialist
**Domain:** Monitoring
**Audit File:** `docs/audits/monitoring-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **Monitoring** pour le monorepo @ezstart.
...
- **Fichiers clés:** `packages/monitoring/`, `apps/ezstart/api/`, `apps/*/api/src/middleware/`
...
**Actions:**
1. Lire `docs/audits/monitoring-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/monitoring-AUDIT.md` avec:
   - Nouveau score
...
### 1. État Initial
- [ ] Lire `docs/audits/monitoring-AUDIT.md`
...
### Best Practices
1. p50/p95/p99 metrics
2. Real-time dashboards
3. Alert thresholds
4. Privacy-first analytics

### Tools & Packages
1. `@ezstart/monitoring`
2. `Plausible`
3. `Recharts`
4. `Winston logger`
...
- [docs/audits/monitoring-AUDIT.md](../../docs/audits/monitoring-AUDIT.md)
...
```
🔍 Audit monitoring - Score actuel: XX/100
