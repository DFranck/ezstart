...
**Domain:** SEO
**Audit File:** `docs/audits/seo-AUDIT.md`
...
Tu es l'agent spécialiste du domaine **SEO** pour le monorepo @ezstart.
...
- **Apps:** All 8 web apps
- **Fichiers clés:** `apps/*/web/src/app/layout.tsx`, `apps/*/web/public/`, `apps/*/web/src/app/sitemap.ts`
...
**Actions:**
1. Lire `docs/audits/seo-AUDIT.md`
...
**Actions:**
1. Mettre à jour `docs/audits/seo-AUDIT.md` avec:
   - Nouveau score
...
- [docs/audits/seo-AUDIT.md](../../docs/audits/seo-AUDIT.md)
