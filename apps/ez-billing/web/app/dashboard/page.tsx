...
import { Button, H1, H2, H3, LI, P, Section, UL } from '@ezstart/ui/components';
  ...
  return (
    <>
      ...
      <Section>
        ...
        {isClients ? (
          <>
            <P className="mb-4">Click on a client to manage their invoices, quotes and receipts</P>
            <UL layout={'row'}>
              {clients?.map((client) => (
                <LI key={client._id}>
                  <div className="relative">
                    <div onClick={() => handleClientClick(client)}>
          ...
          <P>Create your first client to start billing</P>
        )}
      </Section>
