...
import { Button, Card, CardContent, H1, Icon, KnownIconName, Section } from '@ezstart/ui/components'
        ...
        <Section size={'full'}>
          ...
          <div className="relative container mx-auto px-4 py-20">
            <div className="text-center max-w-4xl mx-auto">
              <H1 className="bg-gradient-to-r from-ezstart to-info bg-clip-text text-transparent mb-6">
                🏮 Feng Shui Bagua
              </H1>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="bg-card rounded-3xl shadow-xl p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Commencez votre analyse gratuite et découvrez comment le Feng Shui peut améliorer
              votre quotidien.
            </p>
            <Link href="/analyze">
