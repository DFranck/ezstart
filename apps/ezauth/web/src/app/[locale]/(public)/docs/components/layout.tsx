...
/**
 * Nested layout for the auth-sdk component showcase
 * (`/{locale}/docs/components/*`). Adds the registry-driven tree sidebar
 * and the Cmd+K command palette to the docs shell. The outer `<DocsTopBar>`
 * is provided by the parent `/docs/layout.tsx`.
 */
