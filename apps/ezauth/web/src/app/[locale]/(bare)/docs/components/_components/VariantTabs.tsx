...
export interface VariantTabsProps {
  /** Variant entries — each declares its label (`'Form'`, `'Card'`, ...) and the slug used in the URL param. */
...
/**
 * Tab strip used to swap between the Form/Card/Modal variants of a
 * feature group (Sign In, Sign Up, Forgot Password, Reset Password,
 * Verify Email). Renders as a Radix Tabs `<TabsList>` so keyboard
