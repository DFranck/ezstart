/**
 * Shared HTML helpers for ezauth-local email templates.
 *
 ...
 * email-service package every time ezauth ships a new email type.
 *
...
export interface LocalEmailContext {
  /** Brand display name (e.g. `'EZAuth'`, `'GreenPulse.AI'`). */
  appName: string
...
/**
 * Render the standard ezauth email layout. Matches the visual style and
