    ...
    <Main>
      ...
      <Hero
        title={
          <span className='text-black'>
            Transplantation d’arbres matures et déplacement d'arbres sur
            chantier.
          </span>
        }
        subtitle={
      ...
      <Section layout={'grid'}>
        ...
        <Div className='text-center'>
          ...
          <P>
            Sur chantier ou en milieu naturel. ASC TCD assure le déplacement et
            la reprise racinaire de l’arbre.
          </P>
          <BoutiqueCta />
        </Div>
      </Section>
      ...
      <Section className='py-12 text-center'>
        ...
        <div className='mt-8 w-full overflow-x-auto'>
          <div className='inline-block min-w-full align-middle'>
            <table className='border border-gray-200 text-left text-xs sm:text-sm rounded-none sm:rounded-lg overflow-hidden min-w-[700px]'>
              ...
              <tbody>
                {[
                  ...
                  },
                  {
                    ...
                    deplacement:
                      'Forte à modérée selon la communication sur le projet',
                  },
                  {
                    ...
                    deplacement:
                      'Très élevé, bienfaits immédiats esthétiques et écologiques',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    abattage:
                      'Rupture du stockage + libération de CO₂ selon le devenir du bois',
                    deplacement:
                      'Maintien du stockage + poursuite naturelle de la séquestration',
                  },
                ].map((row, index) => (
                  <tr
                    key={index}
                  ...
                  >
                    ...
                    <td
                      className={cn(
                        'p-3 border whitespace-normal',
                        row.deplacement.includes('✓') ||
                          row.deplacement === 'Immédiat'
        ...
        <P className='mt-6 text-xs sm:text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed px-4'>
          Lorsqu’un arbre adulte se trouve sur le tracé d’un projet urbain, deux
          options s’opposent : l’abattage ou la transplantation. Voici une
          comparaison claire des impacts environnementaux, techniques et sociaux
          pour vous aider à faire un choix éclairé.
        </P>
      </Section>
      ...
      <Section className='overflow-hidden pb-20'>
        ...
        <P className='text-center mt-2'>
          Besoin d’enlever, déplacer ou réadapter un arbre adulte,
          TRANSPLANTEZ-LE !
        </P>
