// AUTO-GENERATED by scripts/generators/generate-ui-registry.js — 2026-04-09T19:23:19.422Z
...
export const componentRegistry: Record<string, ComponentEntry> = {
  ...
  AnimatedCounter: {
    ...
    level: 'base',
    tokens: [{ name: 'easing', category: 'visual' }],
    props: [
  ...
  AuroraBackground: {
    ...
    children: [],
    slots: [{ name: 'children', required: true, isRenderProp: false }],
    description: 'Base component',
  ...
  Input: {
    ...
    children: [],
    slots: [
      { name: 'startIcon', required: false, isRenderProp: false },
      { name: 'endIcon', required: false, isRenderProp: false },
    ],
    description: 'Base component',
  ...
  Modal: {
    ...
    slots: [
      { name: 'children', required: true, isRenderProp: false },
      { name: 'title', required: false, isRenderProp: false },
      { name: 'description', required: false, isRenderProp: false },
      { name: 'footer', required: false, isRenderProp: false },
    ],
    description: 'Base component with size token',
  ...
  ThreadHeader: {
    ...
    children: [],
    slots: [
      { name: 'left', required: false, isRenderProp: false },
      { name: 'right', required: false, isRenderProp: false },
    ],
    description: 'Base component',
  ...
  Dropdown: {
    ...
    slots: [
      { name: 'label', required: false, isRenderProp: false },
      { name: 'trigger', required: false, isRenderProp: false },
    ],
    description:
  ...
  FloatingPanel: {
    ...
    children: ['Button'],
    slots: [{ name: 'title', required: false, isRenderProp: false }],
    description: 'Composed component using Button',
  ...
  Footer: {
    ...
    children: [],
    slots: [
      { name: 'creator', required: false, isRenderProp: false },
      { name: 'topContent', required: false, isRenderProp: false },
      { name: 'leftContent', required: false, isRenderProp: false },
      { name: 'centerContent', required: false, isRenderProp: false },
      { name: 'rightContent', required: false, isRenderProp: false },
      { name: 'bottomContent', required: false, isRenderProp: false },
    ],
  ...
  Hero: {
    ...
    slots: [
      { name: 'title', required: false, isRenderProp: false },
      { name: 'subtitle', required: false, isRenderProp: false },
      { name: 'paragraph', required: false, isRenderProp: false },
      { name: 'children', required: false, isRenderProp: false },
    ],
    description:
  ...
  PWAInstallPrompt: {
    ...
    slots: [{ name: 'fallback', required: false, isRenderProp: false }],
  ...
  ThreadComposer: {
    ...
    children: ['Button'],
    slots: [
      { name: 'welcomeMessage', required: false, isRenderProp: false },
      { name: 'headerSlot', required: false, isRenderProp: false },
    ],
    description: 'Composed component using Button',
  ...
  ThreadMessages: {
    ...
    slots: [{ name: 'renderMessage', required: false, isRenderProp: true }],
  ...
  ClientLayout: {
    ...
    slots: [
      { name: 'children', required: true, isRenderProp: false },
      { name: 'headerLeftContent', required: false, isRenderProp: false },
      { name: 'headerCenterContent', required: false, isRenderProp: false },
      { name: 'headerRightContent', required: false, isRenderProp: false },
      { name: 'creator', required: false, isRenderProp: false },
      { name: 'footerTopContent', required: false, isRenderProp: false },
      { name: 'footerLeftContent', required: false, isRenderProp: false },
      { name: 'footerCenterContent', required: false, isRenderProp: false },
      { name: 'footerRightContent', required: false, isRenderProp: false },
      { name: 'footerBottomContent', required: false, isRenderProp: false },
    ],
    description:
  ...
  ErrorBoundary: {
    ...
    slots: [
      { name: 'children', required: true, isRenderProp: false },
      { name: 'fallback', required: false, isRenderProp: false },
    ],
    description:
  ...
  LandingHero: {
    ...
    slots: [{ name: 'children', required: false, isRenderProp: false }],
    description:
  ...
  StepSummary: {
    ...
    slots: [{ name: 'button', required: true, isRenderProp: false }],
    description:
      'Complex component orchestrating Button, Icon, Div, Span, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger',
    sourcePath: 'packages/ui/src/components/navigation/stepper.tsx',
  },
  ...
  ThreadLayout: {
    ...
    slots: [
      { name: 'children', required: true, isRenderProp: false },
      { name: 'sidebar', required: false, isRenderProp: false },
      { name: 'sidebarToggle', required: false, isRenderProp: false },
    ],
    description:
  ...
  ThreadSidebar: {
    ...
    slots: [
      { name: 'emptyState', required: false, isRenderProp: false },
      { name: 'header', required: false, isRenderProp: false },
      { name: 'footer', required: false, isRenderProp: false },
      { name: 'beforeConversations', required: false, isRenderProp: false },
      { name: 'afterConversations', required: false, isRenderProp: false },
      { name: 'renderConversation', required: false, isRenderProp: true },
    ],
