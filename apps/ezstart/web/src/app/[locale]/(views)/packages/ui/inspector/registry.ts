// AUTO-GENERATED by scripts/generators/generate-ui-registry.js — 2026-04-10T00:59:02.950Z
...
export const componentRegistry: Record<string, ComponentEntry> = {
  ...
  AnimatedCounter: {
    ...
    level: 'base',
    tokens: [
      { name: 'easing', category: 'visual', values: ['linear', 'easeOutQuart', 'easeInOutQuart'] },
      {
        name: 'variant',
        category: 'visual',
  ...
  Badge: {
    ...
    tokens: [
      ...
      { name: 'circle', category: 'visual' },
      { name: 'circleSize', category: 'visual', values: ['sm', 'md', 'lg', 'xl'] },
    ],
    props: [
  ...
  ChartTooltipContent: {
    ...
    level: 'base',
    tokens: [{ name: 'indicator', category: 'visual', values: ['line', 'dot', 'dashed'] }],
    props: [
  ...
  DesignTokenProvider: {
    ...
    description: 'Base component',
    sourcePath: 'packages/ui/src/lib/design-system/DesignTokenContext.tsx',
  },
  DialogClose: {
    name: 'DialogClose',
    level: 'base',
  ...
  Div: {
    name: 'Div',
    level: 'base',
    tokens: [{ name: 'withHeaderOffset', category: 'visual' }],
    props: [],
    children: [],
    slots: [],
    providesTokens: [],
  ...
  FlowConnector: {
    ...
    level: 'base',
    tokens: [
      { name: 'fromSide', category: 'visual', values: ['top', 'right', 'bottom', 'left'] },
      { name: 'toSide', category: 'visual', values: ['top', 'right', 'bottom', 'left'] },
      { name: 'pathStyle', category: 'visual', values: ['smooth', 'angular'] },
    ],
    props: [
      {
        name: 'fromSide',
  ...
  Footer: {
    name: 'Footer',
    level: 'base',
    tokens: [{ name: 'layout', category: 'visual', values: ['simple', 'columns', 'stacked'] }],
    props: [
  ...
  FooterTag: {
    ...
    tokens: [
      ...
      { name: 'layout', category: 'visual', values: ['default', 'centered', 'spaced'] },
      { name: 'withFixedMobilebar', category: 'visual' },
    ],
    props: [],
    children: [],
    slots: [],
  ...
  ImageCropper: {
    ...
    level: 'base',
    tokens: [
      { name: 'mode', category: 'visual', values: ['pan-zoom', 'edge-drag', 'round'] },
      { name: 'outputFormat', category: 'visual', values: ['image/png', 'image/jpeg'] },
      { name: 'cropShape', category: 'visual', values: ['rect', 'round'] },
    ],
    props: [
  ...
  InfiniteMovingCards: {
    ...
    level: 'base',
    tokens: [
      { name: 'direction', category: 'visual', values: ['left', 'right'] },
      { name: 'speed', category: 'visual', values: ['fast', 'normal', 'slow'] },
    ],
    props: [
  ...
  LI: {
    ...
    tokens: [
      ...
      { name: 'button', category: 'visual' },
      { name: 'marker', category: 'visual', values: ['default', 'check', 'arrow', 'dash'] },
    ],
    props: [],
    children: [],
    slots: [],
  ...
  SheetClose: {
    name: 'SheetClose',
    level: 'base',
    tokens: [{ name: 'side', category: 'visual', values: ['top', 'right', 'bottom', 'left'] }],
    props: [
      {
        name: 'side',
        type: "'top' | 'right' | 'bottom' | 'left'",
  ...
  SkeletonText: {
    ...
    tokens: [
      { name: 'variant', category: 'visual', values: ['default', 'lighter', 'darker', 'shimmer'] },
      { name: 'spacing', category: 'visual', values: ['tight', 'normal', 'loose'] },
    ],
    props: [
      { name: 'lines', type: 'number', required: false, isDesignToken: false },
      {
  ...
  Spinner: {
    ...
    tokens: [
      ...
      { name: 'speed', category: 'visual', values: ['slow', 'normal', 'fast'] },
      { name: 'textSize', category: 'visual', values: ['xs', 'sm', 'md', 'lg'] },
      { name: 'fancyPulseSize', category: 'visual', values: ['xs', 'sm', 'md', 'lg', 'xl'] },
    ],
    props: [
      {
        name: 'size',
  ...
  TextGradient: {
    name: 'TextGradient',
    level: 'base',
    tokens: [{ name: 'direction', category: 'visual' }],
    props: [
  ...
  Toaster: {
    name: 'Toaster',
    level: 'base',
    tokens: [{ name: 'theme', category: 'visual', values: ['light', 'dark', 'system'] }],
    props: [
  ...
  Card: {
    ...
    tokens: [
      ...
      { name: 'interactive', category: 'visual' },
      { name: 'hover', category: 'visual', values: ['none', 'lift', 'glow', 'border', 'scale'] },
    ],
    props: [
    ...
    description:
      'Composed component using DesignTokenProvider, CardAction, CardContent, CardDescription, CardFooter, CardHeader, CardTitle — drills density, variant, size, interactive, hover to children',
  ...
  CardAction: {
    ...
    tokens: [],
    props: [],
    children: ['DesignTokenProvider'],
    slots: [],
    providesTokens: ['size', 'density', 'radius'],
    inheritsTokens: ['size', 'density'],
    description: 'Composed component using DesignTokenProvider',
    sourcePath: 'packages/ui/src/components/data-display/card.tsx',
  },
  CardContent: {
    name: 'CardContent',
    ...
    providesTokens: ['size', 'density', 'radius'],
    inheritsTokens: ['size', 'density'],
    description: 'Composed component using DesignTokenProvider — drills size, density to children',
    sourcePath: 'packages/ui/src/components/data-display/card.tsx',
  },
  CardDescription: {
  ...
  Carousel: {
    name: 'Carousel',
    level: 'composed',
    tokens: [{ name: 'orientation', category: 'visual', values: ['horizontal', 'vertical'] }],
    props: [
  ...
  CTA: {
    ...
    tokens: [
      ...
      { name: 'bgColor', category: 'visual', values: ['default', 'primary', 'muted'] },
      {
        name: 'container',
        category: 'visual',
        values: ['default', 'centered', 'split', 'minimal', 'gradient', 'bordered'],
      ...
      { name: 'title', category: 'visual', values: ['default', 'minimal'] },
      { name: 'buttons', category: 'visual', values: ['default', 'centered', 'split'] },
    ],
    props: [
      {
        name: 'variant',
  ...
  DataTable: {
    ...
    level: 'composed',
    tokens: [
      { name: 'tableSize', category: 'visual', values: ['compact', 'default', 'comfortable'] },
    ],
    props: [
  ...
  FeatureGrid: {
    ...
    tokens: [
      ...
      { name: 'columns', category: 'visual', values: ['2', '3', '4'] },
      {
        name: 'cardVariant',
        category: 'visual',
        values: ['default', 'minimal', 'bordered', 'floating'],
  ...
  FloatingPanelDescription: {
    ...
    tokens: [],
    props: [],
    children: ['DesignTokenProvider', 'Button'],
    slots: [],
    providesTokens: ['size'],
    inheritsTokens: [],
    description: 'Composed component using DesignTokenProvider, Button',
  ...
  Header: {
    ...
    tokens: [
      { name: 'size', category: 'structural', values: ['xs', 'sm', 'xl', 'full', 'default'] },
      { name: 'layout', category: 'visual', values: ['default', 'centered', 'spaced'] },
      { name: 'position', category: 'visual', values: ['static', 'sticky', 'fixed', 'absolute'] },
    ],
    props: [],
    children: ['Div', 'Tag'],
    slots: [],
  ...
  Table: {
    ...
    inheritsTokens: [],
    description:
      'Composed component using DesignTokenProvider, TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader, TableRow — drills density, variant, size to children',
  ...
  ClientLayout: {
    ...
    level: 'complex',
    tokens: [
      { name: 'footerLayout', category: 'visual', values: ['simple', 'columns', 'stacked'] },
    ],
    props: [
      { name: 'appName', type: 'string', required: true, isDesignToken: false },
      { name: 'currentPath', type: 'string', required: false, isDesignToken: false },
  ...
  Dropdown: {
    ...
    tokens: [
      { name: 'variant', category: 'visual' },
      { name: 'align', category: 'visual', values: ['start', 'center', 'end'] },
      { name: 'side', category: 'visual', values: ['top', 'bottom'] },
    ],
    props: [
  ...
  FloatingPanel: {
    ...
    inheritsTokens: [],
    description:
      'Complex component orchestrating DesignTokenProvider, Button, FloatingPanelDescription, FloatingPanelFooter, FloatingPanelHeader, FloatingPanelTitle — drills size through children',
    sourcePath: 'packages/ui/src/components/overlay/floating-panel.tsx',
  },
  Hero: {
    name: 'Hero',
    ...
    tokens: [
      ...
      { name: 'layout', category: 'visual', values: ['center', 'grid'] },
      { name: 'mediaPosition', category: 'visual', values: ['left', 'right'] },
      { name: 'brightness', category: 'visual', values: ['light', 'dark', 'auto'] },
      { name: 'height', category: 'visual', values: ['sm', 'md', 'lg', 'viewport', 'auto'] },
      { name: 'alignment', category: 'visual', values: ['left', 'center', 'right'] },
    ],
    props: [
  ...
  LandingHero: {
    ...
    tokens: [
      { name: 'variant', category: 'visual' },
      { name: 'bgMode', category: 'visual', values: ['scroll', 'fixed'] },
      {
        name: 'container',
        category: 'visual',
        values: [
  ...
  SplitSection: {
    ...
    level: 'complex',
    tokens: [
      { name: 'diagonalDirection', category: 'visual', values: ['left', 'right'] },
      { name: 'size', category: 'structural' },
      { name: 'layout', category: 'visual', values: ['horizontal', 'vertical'] },
      { name: 'align', category: 'visual', values: ['start', 'center', 'end', 'stretch'] },
      { name: 'padding', category: 'visual', values: ['none', 'sm', 'md', 'lg', 'xl'] },
    ],
    props: [
  ...
  ThreadMessage: {
    name: 'ThreadMessage',
    level: 'complex',
    tokens: [{ name: 'role', category: 'visual', values: ['user', 'ai'] }],
    props: [
...
export const popularChains = [
  ...
  {
    label: 'FloatingPanel → FloatingPanelDescription → DesignTokenProvider',
    chain: ['FloatingPanel', 'FloatingPanelDescription', 'DesignTokenProvider'],
  },
  {
    label: 'FloatingPanel → FloatingPanelFooter → DesignTokenProvider',
    chain: ['FloatingPanel', 'FloatingPanelFooter', 'DesignTokenProvider'],
  },
  {
    label: 'FloatingPanel → FloatingPanelHeader → DesignTokenProvider',
    chain: ['FloatingPanel', 'FloatingPanelHeader', 'DesignTokenProvider'],
  },
  {
    label: 'FloatingPanel → FloatingPanelTitle → DesignTokenProvider',
    chain: ['FloatingPanel', 'FloatingPanelTitle', 'DesignTokenProvider'],
  },
