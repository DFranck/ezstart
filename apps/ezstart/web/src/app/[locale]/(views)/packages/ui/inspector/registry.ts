// AUTO-GENERATED by scripts/generators/generate-ui-registry.js — 2026-04-10T03:00:41.579Z
...
export const componentRegistry: Record<string, ComponentEntry> = {
  ...
  CarouselContent: {
    ...
    providesTokens: [],
    inheritsTokens: [],
    description: 'Atomic component with orientation token',
  ...
  CTA: {
    ...
    inheritsTokens: [],
    description:
      'Atomic component with variant, bgColor, container, content, title, buttons tokens',
  ...
  Header: {
    ...
    providesTokens: [],
    inheritsTokens: ['size', 'density', 'intent'],
    description: 'Atomic component with size, layout, position tokens',
  ...
  ThreadMessage: {
    ...
    providesTokens: [],
    inheritsTokens: [],
    description: 'Atomic component with role token',
  ...
  VersionSwitch: {
    ...
    providesTokens: [],
    inheritsTokens: ['size'],
    description: 'Atomic component with position, size tokens',
    sourcePath: 'packages/ui/src/components/utility/version-switch.tsx',
  },

  // ─── Molecule (23 components) ────────────────────
  Accordion: {
    name: 'Accordion',
    level: 'molecule',
    tokens: [],
    ...
    inheritsTokens: [],
    description:
      'Molecular component using Icon, AccordionContent, AccordionItem, AccordionTrigger',
    sourcePath: 'packages/ui/src/components/data-display/accordion.tsx',
  },
  AlertDialog: {
    name: 'AlertDialog',
  ...
  Carousel: {
    ...
    inheritsTokens: [],
    description:
      'Molecular component using Button, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious — drills orientation to children',
    sourcePath: 'packages/ui/src/components/media/carousel.tsx',
  },
  ChartLegend: {
    name: 'ChartLegend',
  ...
  Command: {
    ...
    inheritsTokens: [],
    description:
      'Molecular component using Dialog, DialogTitle, DialogDescription, DialogContent, DialogHeader, CommandDialog, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandSeparator, CommandShortcut',
  ...
  DataTable: {
    ...
    inheritsTokens: [],
    description:
      'Molecular component using Table, TableBody, TableCell, TableHead, TableHeader, TableRow, Button, Input, DataTableColumnHeader, DataTablePagination — drills tableSize to children',
  ...
  Form: {
    ...
    inheritsTokens: [],
    description:
      'Molecular component using Label, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage',
    sourcePath: 'packages/ui/src/components/forms/form.tsx',
  },
  IconGallery: {
    name: 'IconGallery',
  ...
  LandingFAQ: {
    ...
    inheritsTokens: [],
    description:
      'Molecular component using Accordion, AccordionContent, AccordionItem, AccordionTrigger',
  ...
  PasswordInput: {
    ...
    providesTokens: [],
    inheritsTokens: [],
    description: 'Molecular component using AnimatedIconToggle, Button, Input',
  ...
  SplitSection: {
    ...
    inheritsTokens: ['size'],
    description:
      'Molecular component using Div, Section, SplitSectionItem — drills diagonalDirection, size, layout, align, padding to children',
    sourcePath: 'packages/ui/src/components/layout/split-section.tsx',
  },
  Table: {
    name: 'Table',
  ...
  Dropdown: {
    ...
    inheritsTokens: [],
    description:
      'Organism orchestrating Button, LI, UL — drills variant, align, side through children',
  ...
  Hero: {
    ...
    inheritsTokens: [],
    description:
      'Organism orchestrating H1, P, Section, Div — drills size, layout, mediaPosition, brightness, height, alignment through children',
  ...
  LandingHero: {
    ...
    inheritsTokens: [],
    description:
      'Organism orchestrating Button, Badge, Section, Div, H1, P — drills variant, bgMode, container, contentWrapper, title, description through children',
  ...
  ClientLayout: {
    ...
    inheritsTokens: [],
    description:
      'Template layout with Burger, Button, Icon, SkipLink, Div, Main, Footer, Header — orchestrates footerLayout across sections',
  ...
  ThreadLayout: {
    ...
    inheritsTokens: [],
    description:
      'Template layout with Button, Icon, ThreadThemeProvider — orchestrates colorScheme across sections',
...
export const popularChains = [
  ...
  {
    label: 'CommandDialog → Dialog → DialogClose',
    chain: ['CommandDialog', 'Dialog', 'DialogClose'],
  },
  {
    label: 'CommandInput → Dialog → DialogClose',
    chain: ['CommandInput', 'Dialog', 'DialogClose'],
  },
  { label: 'CommandList → Dialog → DialogClose', chain: ['CommandList', 'Dialog', 'DialogClose'] },
  {
    label: 'CommandEmpty → Dialog → DialogClose',
    chain: ['CommandEmpty', 'Dialog', 'DialogClose'],
  },
  {
    label: 'CommandGroup → Dialog → DialogClose',
    chain: ['CommandGroup', 'Dialog', 'DialogClose'],
  },
  { label: 'CommandItem → Dialog → DialogClose', chain: ['CommandItem', 'Dialog', 'DialogClose'] },
  {
    label: 'CommandShortcut → Dialog → DialogClose',
    chain: ['CommandShortcut', 'Dialog', 'DialogClose'],
  },
]
