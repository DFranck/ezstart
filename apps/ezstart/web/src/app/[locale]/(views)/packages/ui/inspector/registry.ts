// AUTO-GENERATED by scripts/generators/generate-ui-registry.js — 2026-04-09T20:06:15.395Z
...
export const componentRegistry: Record<string, ComponentEntry> = {
  ...
  Aside: {
    ...
    tokens: [
      { name: 'size', category: 'structural' },
      { name: 'layout', category: 'visual' },
      { name: 'variant', category: 'visual' },
      { name: 'intent', category: 'visual' },
      { name: 'density', category: 'structural' },
    ],
    props: [],
    children: [],
    slots: [],
    description: 'Base component with size, layout, variant, intent, density tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  AuroraBackground: {
  ...
  Badge: {
    ...
    tokens: [
      ...
      { name: 'circleSize', category: 'visual' },
    ],
    props: [
  ...
  ChartTooltip: {
    name: 'ChartTooltip',
    level: 'base',
    tokens: [{ name: 'indicator', category: 'visual' }],
    props: [
  ...
  Div: {
    ...
    tokens: [
      { name: 'size', category: 'structural' },
      { name: 'layout', category: 'visual' },
      { name: 'withHeaderOffset', category: 'visual' },
      { name: 'variant', category: 'visual' },
      { name: 'intent', category: 'visual' },
      { name: 'density', category: 'structural' },
    ],
    ...
    slots: [],
    description:
      'Base component with size, layout, withHeaderOffset, variant, intent, density tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  FlowConnector: {
    name: 'FlowConnector',
    level: 'base',
    tokens: [
      { name: 'fromSide', category: 'visual' },
      { name: 'toSide', category: 'visual' },
      { name: 'pathStyle', category: 'visual' },
    ],
    props: [
      {
        name: 'fromSide',
  ...
  FooterTag: {
    ...
    children: [],
    slots: [],
    description: 'Base component with variant, size, intent, layout, withFixedMobilebar tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  H1: {
    name: 'H1',
  ...
  ImageCropper: {
    ...
    level: 'base',
    tokens: [
      { name: 'mode', category: 'visual' },
      { name: 'outputFormat', category: 'visual' },
      { name: 'cropShape', category: 'visual' },
    ],
    props: [
  ...
  InfiniteMovingCards: {
    ...
    level: 'base',
    tokens: [
      { name: 'direction', category: 'visual' },
      { name: 'speed', category: 'visual' },
    ],
    props: [
  ...
  LI: {
    ...
    tokens: [
      ...
      { name: 'marker', category: 'visual' },
    ],
    props: [],
    children: [],
    slots: [],
    description: 'Base component with variant, intent, size, layout, button, marker tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  Main: {
    name: 'Main',
    ...
    children: [],
    slots: [],
    description: 'Base component with intent, density, withHeaderOffset tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  Modal: {
    name: 'Modal',
  ...
  P: {
    ...
    tokens: [
      ...
      { name: 'size', category: 'structural' },
      { name: 'intent', category: 'visual' },
      { name: 'weight', category: 'visual' },
    ],
    props: [],
    children: [],
    slots: [],
    description: 'Base component with variant, size, intent, weight tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  Progress: {
    name: 'Progress',
  ...
  Section: {
    ...
    children: [],
    slots: [],
    description: 'Base component with variant, size, intent, layout, density tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  Select: {
    name: 'Select',
  ...
  Sheet: {
    name: 'Sheet',
    level: 'base',
    tokens: [{ name: 'side', category: 'visual' }],
    props: [
      {
        name: 'side',
        type: "'top' | 'right' | 'bottom' | 'left'",
  ...
  Span: {
    ...
    children: [],
    slots: [],
    description: 'Base component with size, intent, variant, layout tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  Spinner: {
    name: 'Spinner',
    ...
    tokens: [
      ...
      { name: 'variant', category: 'visual' },
      { name: 'speed', category: 'visual' },
      { name: 'textSize', category: 'visual' },
      { name: 'fancyPulseSize', category: 'visual' },
    ],
    props: [
      {
        name: 'size',
  ...
  Toaster: {
    name: 'Toaster',
    level: 'base',
    tokens: [{ name: 'theme', category: 'visual' }],
    props: [
  ...
  UL: {
    ...
    children: [],
    slots: [],
    description: 'Base component with variant, intent, size, layout tokens',
    sourcePath: 'packages/ui/src/components/tag/index.ts',
  },
  UptimeGraph: {
    name: 'UptimeGraph',
  ...
  AlertDialog: {
    ...
    tokens: [
      { name: 'variant', category: 'visual' },
      { name: 'actionButtonVariant', category: 'visual' },
    ],
    props: [{ name: 'variant', type: 'AlertDialogVariant', required: false, isDesignToken: true }],
    children: [],
    slots: [],
    description: 'Composed component — drills variant, actionButtonVariant to children',
  ...
  Carousel: {
    name: 'Carousel',
    level: 'composed',
    tokens: [{ name: 'orientation', category: 'visual' }],
    props: [
  ...
  CommandGroup: {
    name: 'CommandGroup',
    level: 'composed',
    tokens: [{ name: 'headingVariant', category: 'visual' }],
    props: [],
    children: ['Dialog', 'DialogTitle', 'DialogDescription', 'DialogContent', 'DialogHeader'],
    slots: [],
    description:
  ...
  CTA: {
    ...
    tokens: [
      { name: 'variant', category: 'visual' },
      { name: 'bgColor', category: 'visual' },
      { name: 'container', category: 'visual' },
      { name: 'content', category: 'visual' },
      { name: 'title', category: 'visual' },
      { name: 'buttons', category: 'visual' },
    ],
    props: [
      {
        name: 'variant',
  ...
  DataTable: {
    name: 'DataTable',
    level: 'composed',
    tokens: [{ name: 'tableSize', category: 'visual' }],
    props: [
  ...
  Dropdown: {
    ...
    tokens: [
      { name: 'variant', category: 'visual' },
      { name: 'align', category: 'visual' },
      { name: 'side', category: 'visual' },
    ],
    props: [
  ...
  FloatingPanel: {
    ...
    description: 'Composed component using Button — drills size to children',
  ...
  Footer: {
    name: 'Footer',
    level: 'composed',
    tokens: [{ name: 'layout', category: 'visual' }],
    props: [
  ...
  Header: {
    ...
    tokens: [
      ...
      { name: 'intent', category: 'visual' },
      { name: 'layout', category: 'visual' },
      { name: 'position', category: 'visual' },
    ],
    props: [],
    children: ['Div', 'Tag'],
    slots: [],
    description:
      'Composed component using Div, Tag — drills variant, size, intent, layout, position to children',
  ...
  Hero: {
    ...
    tokens: [
      { name: 'size', category: 'structural' },
      { name: 'layout', category: 'visual' },
      { name: 'mediaPosition', category: 'visual' },
      { name: 'brightness', category: 'visual' },
      { name: 'height', category: 'visual' },
      { name: 'alignment', category: 'visual' },
    ],
    props: [
    ...
    description:
      'Composed component using H1, P, Section, Div — drills size, layout, mediaPosition, brightness, height, alignment to children',
  ...
  SplitSection: {
    ...
    level: 'composed',
    tokens: [
      { name: 'diagonalDirection', category: 'visual' },
      { name: 'size', category: 'structural' },
      { name: 'layout', category: 'visual' },
      { name: 'align', category: 'visual' },
      { name: 'padding', category: 'visual' },
    ],
    props: [
    ...
    slots: [{ name: 'children', required: true, isRenderProp: false, expectedComponents: [] }],
    description:
      'Composed component using Div, Section — drills diagonalDirection, size, layout, align, padding to children',
  ...
  ThreadMessage: {
    name: 'ThreadMessage',
    level: 'composed',
    tokens: [{ name: 'role', category: 'visual' }],
    props: [
  ...
  ClientLayout: {
    name: 'ClientLayout',
    level: 'complex',
    tokens: [{ name: 'footerLayout', category: 'visual' }],
    props: [
      { name: 'appName', type: 'string', required: true, isDesignToken: false },
      { name: 'currentPath', type: 'string', required: false, isDesignToken: false },
      { name: 'showHeader', type: 'boolean', required: false, isDesignToken: false },
  ...
  FeatureGrid: {
    ...
    tokens: [
      { name: 'variant', category: 'visual' },
      { name: 'columns', category: 'visual' },
      { name: 'cardVariant', category: 'visual' },
    ],
    props: [
    ...
    slots: [],
    description:
      'Complex component orchestrating Card, CardContent, CardDescription, CardHeader, CardTitle, Badge — drills variant, columns, cardVariant through children',
  ...
  LandingHero: {
    ...
    tokens: [
      { name: 'variant', category: 'visual' },
      { name: 'bgMode', category: 'visual' },
      { name: 'container', category: 'visual' },
      { name: 'contentWrapper', category: 'visual' },
      { name: 'title', category: 'visual' },
      { name: 'description', category: 'visual' },
    ],
    props: [
