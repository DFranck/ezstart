// AUTO-GENERATED by scripts/generators/generate-ui-registry.js — 2026-04-09T21:08:43.260Z
...
export const componentRegistry: Record<string, ComponentEntry> = {
  ...
  CardContent: {
    name: 'CardContent',
    level: 'base',
    tokens: [{ name: 'size', category: 'structural', values: ['xs', 'sm', 'default', 'lg', 'xl'] }],
    props: [
      {
        name: 'size',
  ...
  Input: {
    ...
    description: 'Base component with size, variant, intent tokens',
  ...
  Card: {
    ...
    slots: [],
    description:
      'Composed component using CardAction, CardContent, CardDescription, CardFooter, CardHeader, CardTitle — drills variant, size, interactive, hover to children',
    sourcePath: 'packages/ui/src/components/data-display/card.tsx',
  },
  Carousel: {
    name: 'Carousel',
  ...
  Table: {
    ...
    slots: [],
    description:
      'Composed component using TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader, TableRow — drills variant, size to children',
    sourcePath: 'packages/ui/src/components/data-display/table.tsx',
  },
  Tabs: {
    name: 'Tabs',
  ...
  StepSummary: {
    ...
    slots: [{ name: 'button', required: true, isRenderProp: false, expectedComponents: [] }],
    description:
