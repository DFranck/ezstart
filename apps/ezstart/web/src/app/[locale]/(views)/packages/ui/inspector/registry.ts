// AUTO-GENERATED by scripts/generators/generate-ui-registry.js — 2026-04-10T03:05:53.536Z
...
export const componentRegistry: Record<string, ComponentEntry> = {
  ...
  DialogContent: {
    name: 'DialogContent',
    level: 'atom',
    tokens: [{ name: 'radius', category: 'structural' }],
    props: [
      { name: 'showCloseButton', type: 'boolean', required: false, isDesignToken: false },
      { name: 'radius', type: 'DialogRadius', required: false, isDesignToken: true },
    ],
    children: [],
    slots: [],
    providesTokens: [],
    inheritsTokens: ['radius'],
    description: 'Atomic component with radius token',
    sourcePath: 'packages/ui/src/components/overlay/dialog.tsx',
  },
  DialogDescription: {
  ...
  Input: {
    ...
    props: [
      ...
      { name: 'radius', type: 'InputRadius', required: false, isDesignToken: true },
    ],
    children: [],
    slots: [
    ...
    providesTokens: [],
    inheritsTokens: ['size', 'density', 'radius'],
    description: 'Atomic component with size, density, radius, variant, intent tokens',
  ...
  TextArea: {
    ...
    props: [
      ...
      { name: 'radius', type: 'TextAreaRadius', required: false, isDesignToken: true },
    ],
    children: [],
    slots: [],
    providesTokens: [],
    inheritsTokens: ['size', 'density', 'radius'],
    description: 'Atomic component with size, density, radius tokens',
