/**
 * EZStart-specific API wrapper that automatically uses @ezstart/fetch-client
 */
...
/**
 * Wrapper around callApi that automatically sets appName to 'ezstart'
 */
export async function callApi<T = any>(
  endpoint: string,
  options: Omit<CallApiOptions, 'appName'> = {}
) {
  return baseCallApi<T>(endpoint, { ...options, appName: 'ezstart' })
}
