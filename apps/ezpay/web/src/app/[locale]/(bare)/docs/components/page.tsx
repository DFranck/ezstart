...
/**
 * Showcase landing — `/{locale}/docs/components`. Renders the pay-sdk
 * registry projected into 8 high-level domains (Donations / Subscriptions
 * / Billing & Pricing / Purchases / Callback Pages / Connect / Admin &
 * Developer / Utilities). Variants of the same primitive (`DonateButton`
 * / `DonateModal` / `DonationCard` / `DonationWall`) collapse under one
 * feature card.
 *
 ...
 * `@internal`-tagged shells for platform admins curating the public
 * surface.
 */
 ...
 * `/docs/components/donations/donate-modal` lands on the right page.
 *
...
function FeatureCard({
  ...
  const [activeVariant, setActiveVariant] = useState<string>(
    variantLabelToSlug(group.variants[0]?.label ?? 'button')
  )
