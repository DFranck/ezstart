 ...
 * live-previewed in the showcase (e.g. triggers a real Stripe Checkout
 * redirect, requires a sandbox key not yet provisioned, or is mounted
 * by a Next.js route on a specific URL).
 *
 * Devs see a factual "what this component does" message instead of a
 * fake demo or a "sign in to see it live" tease.
 */
