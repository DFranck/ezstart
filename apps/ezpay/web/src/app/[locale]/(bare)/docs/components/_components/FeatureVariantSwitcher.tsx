...
interface FeatureVariantSwitcherProps {
  /**
   * Name of the component currently selected in the URL — `DonateButton`,
   * `DonateModal`, `DonationCard`, `DonationWall`. The switcher resolves
   * the feature group this name belongs to and renders the full variant
   * tabs at the top.
   */
 ...
 * When the user picks a different variant, the URL is updated to point
 * at the new variant's detail page (so refresh + share work) and the
 * wrapped showcase re-renders with the new registry entry.
 *
