      ...
      <Div className="max-w-2xl mx-auto text-center px-4">
        <Div className="mb-12 flex justify-center">
          <Div className="relative w-24 h-24 md:w-32 md:h-32 rounded-full bg-primary/10 flex items-center justify-center">
            <Icon name="lucide:Heart" className="w-12 h-12 md:w-16 md:h-16 text-primary" />
          </Div>
        </Div>

        <H1 className="text-4xl md:text-5xl font-bold mb-6">
          <Span className="text-primary">{t('donateTitle')}</Span>
        </H1>

        <P className="text-xl text-muted-foreground mb-12">{t('donateMessage')}</P>
