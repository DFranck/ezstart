    ...
    >
        ...
        <CardDescription className="space-y-2">
          {client.email && (
            <Div className="flex items-center text-sm text-muted-foreground">
              <Icon
                name="lucide:Mail"
                className={`w-4 h-4 mr-2 ${client.isCompany ? 'text-ezbill-company/60' : 'text-ezbill-client/60'}`}
              />
              <Link
          ...
          {client.address && (
            <Div className="flex items-start text-sm text-muted-foreground">
              <Icon
                name="lucide:MapPin"
                className={`w-4 h-4 mr-2 mt-0.5 flex-shrink-0 ${client.isCompany ? 'text-ezbill-company/60' : 'text-ezbill-client/60'}`}
              />
              <Link
      ...
      {client.website && (
        <CardContent className="pt-0">
          <Div
            className={`flex items-center text-sm ${client.isCompany ? 'text-ezbill-company' : 'text-ezbill-client'}`}
          >
