...
const router = Router()
export const listReceiptsRouter = createRouterWithDoc(listReceiptsRegistry, router, '/receipts')

listReceiptsRouter.get(
  '/',
  authMiddleware,
  validateQuery(getReceiptsQuerySchema),
  secureControllers.getSecureReceiptsController,
  {
