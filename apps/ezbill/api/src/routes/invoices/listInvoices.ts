...
const router = Router();
export const listInvoicesRouter = createRouterWithDoc(
  listInvoicesRegistry,
  router,
  '/invoices'
);

listInvoicesRouter.get('/', authMiddleware, validateQuery(getInvoicesQuerySchema), secureControllers.getSecureInvoicesController, {
