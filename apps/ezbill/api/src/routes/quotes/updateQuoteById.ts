...
const router = Router();
export const updateQuoteByIdRouter = createRouterWithDoc(
  updateQuoteByIdRegistry,
  router,
  '/quotes'
);

updateQuoteByIdRouter.put('/:id', authMiddleware, validateParams(paramsMongoIdSchema), secureControllers.updateSecureQuoteController, {
