...
const router = Router();
export const listQuotesRouter = createRouterWithDoc(
  listQuotesRegistry,
  router,
  '/quotes'
);

listQuotesRouter.get('/', authMiddleware, validateQuery(getQuotesQuerySchema), secureControllers.getSecureQuotesController, {
  summary: 'List Quotes',
  tags: ['Quotes'],
