...
const router = Router();
export const deleteQuoteByIdRouter = createRouterWithDoc(
  deleteQuoteByIdRegistry,
  router,
  '/quotes'
);

deleteQuoteByIdRouter.delete('/:id', authMiddleware, validateParams(paramsMongoIdSchema), secureControllers.softDeleteSecureQuoteController, {
