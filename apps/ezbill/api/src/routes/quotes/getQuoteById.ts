...
const router = Router();
export const getQuoteByIdRouter = createRouterWithDoc(
  getQuoteByIdRegistry,
  router,
  '/quotes'
);

getQuoteByIdRouter.get('/:id', authMiddleware, validateParams(paramsMongoIdSchema), secureControllers.getSecureQuoteByIdController, {
